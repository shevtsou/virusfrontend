...
import { loadStatistic } from "../../api/api";
import { View, Text } from "react-native";
import styled from "styled-components";
import { Divider } from "react-native-paper";
import Counter from "react-native-countup";
    ...
    return (
      ...
      >
        ...
        <CountText style={{ color: color }}>
          <Counter initial={count < 30 ? 0 : count - 30} timing="easeOut" countBy={1} value={count} />
        </CountText>
      </View>
    );
  }
